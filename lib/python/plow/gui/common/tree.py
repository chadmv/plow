...
from plow.gui.manifest import QtCore
...
class NodeContainer(object):
    ...
    def subnodes(self):
        if self._subnodes is None:
            self._subnodes = self._getChildren()
        return self._subnodes
...
class DummyNode(NodeContainer):
    pass

class TreeModel(QtCore.QAbstractItemModel, NodeContainer):
