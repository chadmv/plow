# -*- coding: utf-8 -*-
#
# Plow documentation build configuration file, created by
...
# sys.path.insert(0, os.path.abspath('../plow/client'))
...
project = u'Plow'
copyright = u'2013, Matthew Chambers, Justin Israel'
...
version = plow.__version__.rsplit('.')[0]
# The full version, including alpha/beta/rc tags.
release = plow.__version__
