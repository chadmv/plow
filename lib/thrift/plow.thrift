...
struct DependT {
    ...
    4:required string dependentJobId,
    5:required string dependOnJobId,
    6:optional string dependentLayerId,
    7:optional string dependOnLayerId,
    8:optional string dependentTaskId,
    9:optional string dependOnTaskId,
    10:required string dependentJobName,
    11:required string dependOnJobName,
    12:optional string dependentLayerName,
    13:optional string dependOnLayerName,
    14:optional string dependentTaskName,
    15:optional string dependOnTaskName,
}
